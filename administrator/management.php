...
<html>
      ...
      <div class="container-fluid main-content">
        ...
        <div class="col-lg-9">
          <div class="container-fluid main-content">
            ...
            <div class="page-title">
              <h1>
                Management of <?php print $comArr[$comp_id-1]; ?>
                <br>
                <small>
                  <font color="#06c">From :</font> <?php print $start; ?>
                  <font color="#06c">To :</font> <?php print $end; ?>
                </small>
              </h1>
            </div>
            <div class="row">
                ...
                <div class="widget-container stats-container  fluid-height clearfix">
                  <div class="widget-content padded clearfix">
                    <div class="table-responsive">
                      <?php
                      include "management/management".$comp_id.".php";
                      ?>
                    </div>
                  </div>
                </div>
  ...
  <script type="text/javascript">
    $(function(){
      $('.hos_checkbox').click(function(){
        var cbVal = $(this).val();
        $('.col_' + cbVal).slideToggle();
        // if($(this).is(':checked')){
        //   var cbVal = $(this).val();
        //   $('.col_' + cbVal).slideToggle();
        //
      ...
      $('#brnGenreport').click(function(){
        ...
        if(check==0){
          window.location = 'management.php?complication_id=' + $('#complication').val() + '&start=' + $('#dateFrom').val() + '&end=' + $('#dateTo').val();
        }
        return false;
      });
